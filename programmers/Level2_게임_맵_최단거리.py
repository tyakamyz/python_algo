...
def solution(maps):
    ...
    if maps[0][0] != 1 or maps[row-1][col-1] != 1:
        return -1
    ...
    def bfs():
        ...
        while que:
            ...
            if currentX == row-1 and currentY == col-1:
                result = currentLen
                break
            ...
            for i in range(4):
                ...
                if (nextX >= 0 and nextX < row) and (nextY >= 0 and nextY < col):
                    if maps[nextX][nextY] == 1 and not visited[nextX][nextY]:
                        visited[nextX][nextY] = True
                        que.append((nextX, nextY, currentLen+1))
